...
export default abstract class AbstractGame<T extends GameState> {
    ...
    /**
     * Returns a mapping from user ID to text string for DMs that should be sent to players on the morning of game decisions.
     */
    ...
    async getPreDecisionSungazerPollData(): Promise<{ title: string, values: string[], valueNames?: Record<string, string>, preMessages?: MessengerPayload[] } | undefined> {
        return undefined;
    }
